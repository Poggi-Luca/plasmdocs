...
* $$I_{operators}$$ is the inflation rate due to the rewards that the Operator can get. This is t times the ratio \(1-q\) of Staking to Operator in I_{Staking}. From the below auxiliary formula, $$ I_{operator} = t \(1-q\) I\_{Staking} $$.
